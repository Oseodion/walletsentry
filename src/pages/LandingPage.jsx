      ...
      <section className="dash-section">
        ...
        <div className="dash-window">
          <div className="dash-bar">
            ...
            <div className="dash-url">app.walletsentry.xyz - 4xK9...mR2p</div>
          </div>
          ...
          <div className="footer-top">
            ...
            <div>
              ...
              <div className="footer-links">
                ...
                <a href="https://x.com/ambient_xyz" target="_blank" rel="noreferrer">X - @ambient_xyz</a>
            ...
            <div>
              ...
              <div className="footer-links">
                <a href="https://x.com/Oseodion" target="_blank" rel="noreferrer">X - @Oseodion</a>
                <a href="https://discord.gg/3Seasf7DcB" target="_blank" rel="noreferrer">Ambient Discord</a>
              </div>
            </div>
          </div>
